...
the feature descriptors of shallow layers are beneficial to correctly delineate object boundaries and shapes with high-level semantics
浅层的特征描述符有利于用高级语义正确地描述对象的边界和形状。
