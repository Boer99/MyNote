...
![600](assets/Pasted%20image%2020240322231237.png)
...
- 例如执行 `limit 2000000, 10` ，此时需要 MySQL 排序前 2000010 记录，扫描到2000010行数据，返回 2000000 - 2000010 的记录，其他记录丢弃，查询排序的代价非常大
...
3）*临键锁*（Next-Key Lock）：行锁和间隙锁**组合**，同时锁住数据，并锁住数据前面的间隙 Gap。
...
![700](assets/Pasted%20image%2020240326005339.png)
